...
//
// const shopRipple = new MDCRipple(document.querySelector('.shop-shop'));
// const insightsRipple = new MDCRipple(document.querySelector('.shop-insights'));
// const aboutRipple = new MDCRipple(document.querySelector('.shop-about'));
// //
// const hotdogCheckbox = new MDCCheckbox(document.querySelector('.hotdog-check'));
// const hotdogFormField = new MDCFormField(document.querySelector('.hotdog-form'));
// hotdogFormField.input = hotdogCheckbox;
//
//
// const proteinCheckbox = new MDCCheckbox(document.querySelector('.protein-check'));
// const protienFormField = new MDCFormField(document.querySelector('.protein-form'));
// protienFormField.input = proteinCheckbox;
//
// const tofuCheckbox = new MDCCheckbox(document.querySelector('.tofu-check'));
// const tofuFormField = new MDCFormField(document.querySelector('.tofu-form'));
// tofuFormField.input = proteinCheckbox;
//
// //
...
//
// const anisecheckbox = new MDCCheckbox(document.querySelector('.spice-check'));
// const aniseformField = new MDCFormField(document.querySelector('.spice-form'));
...
//
// const doughnutscheckbox = new MDCCheckbox(document.querySelector('.donuts-check'));
// const doughnutsformField = new MDCFormField(document.querySelector('.donuts-form'));
...
var insightsShopRipple = new _ripple.MDCRipple(document.querySelector('.insights-shop'));
var insightsInsightsRipple = new _ripple.MDCRipple(document.querySelector('.insights-insights'));
var insightsAboutRipple = new _ripple.MDCRipple(document.querySelector('.insights-about'));
// const aisleRipple = new MDCSelect(document.querySelector('.aisle-select'));
